...
function StatusBadge({ status }) {
  ...
  return (
    <span className="crm-badge" style={{ "--badge-color": cfg.color }}>
      {cfg.label}
    </span>
  );
}
        ...
        <div className="crm-status-tabs">
          {STATUS_TABS.map((s) => (
            <button
              ...
              style={
                statusFilter === s && STATUS_CONFIG[s]
                  ? { "--badge-color": STATUS_CONFIG[s].color }
                  : {}
              }
            >
              ...
              {leads.map((lead) => (
                ...
                >
                  ...
                  <td className="crm-table__contact">
                    {lead.phone && <span>{lead.phone}</span>}
                    {lead.email && (
                      <span className="crm-table__email">{lead.email}</span>
                    )}
                  </td>
