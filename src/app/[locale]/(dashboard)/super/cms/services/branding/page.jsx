      ...
      <div className="flex flex-col md:flex-row justify-between items-start md:items-center gap-3 mb-6">
        <div>
          <div className="flex items-center gap-2 text-indigo-600 mb-1">
            ...
            <span className="text-[9px] font-black uppercase tracking-[0.4em]">Service_Tier_Visual_Identity</span>
          </div>
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-3">
                    {content.landing.sections.pillars?.map((item, idx) => (
                        <CardWrapper key={idx} onRemove={() => {
                            ...
                            <textarea placeholder="Psychological intent" rows="3" className="w-full bg-slate-50 border border-transparent focus:bg-white focus:border-slate-100 rounded-xl p-2 text-base md:text-[11px] text-slate-500 leading-relaxed outline-none transition-all scrollbar-hide" value={item.desc} onChange={(e) => {
                                const newArr = [...content.landing.sections.pillars];
            ...
            <section className="bg-slate-900 p-5 rounded-3xl text-white shadow-xl">
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-3">
                    {content.landing.sections.metrics?.map((metric, idx) => (
                        <div key={idx} className="bg-white/5 border border-white/10 p-4 rounded-2xl relative group hover:bg-white/10 transition-all">
                             <button onClick={() => {
                    ...
                    <button onClick={() => {
                        ...
                        updateNested("landing", "sections.metrics", newArr);
                    }} className="h-full min-h-[70px] border-2 border-dashed border-white/10 rounded-2xl flex flex-col items-center justify-center gap-1 text-white/20 hover:text-indigo-400 hover:border-indigo-400/30 hover:bg-white/5 transition-all group p-2">
             ...
             <section className="bg-white p-5 rounded-3xl border border-slate-100 shadow-lg shadow-slate-200/30">
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-px bg-slate-100 border border-slate-100 rounded-2xl overflow-hidden">
                    {content.details.sections.phases?.map((phase, idx) => (
                        <div key={idx} className="p-4 bg-white hover:bg-slate-50 transition-colors relative group">
                            ...
                            <div className="flex items-center gap-3 mb-3">
                                <span className="text-[9px] font-black text-indigo-500 bg-indigo-50 px-2 py-1 rounded shrink-0">{phase.step}</span>
                            ...
                            <textarea placeholder="Strategic action" rows="3" className="w-full bg-transparent border-none outline-none text-base md:text-[10px] text-slate-400 font-medium leading-relaxed scrollbar-hide" value={phase.action} onChange={(e) => {
                                const newArr = [...content.details.sections.phases];
                    ...
                    <button onClick={() => {
                         ...
                         updateNested("details", "sections.phases", newArr);
                    }} className="bg-white flex flex-col items-center justify-center gap-1 text-slate-300 hover:text-indigo-500 hover:bg-slate-50 transition-all min-h-[140px] p-2">
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-y-1 gap-x-8">
                     {content.details.sections.manifest?.map((item, idx) => (
                        <div key={idx} className="flex justify-between items-center py-1.5 border-b border-white/5 last:border-0 group relative gap-2">
                             ...
                             <textarea placeholder="Specification" rows="1" className="w-[55%] bg-transparent border-none outline-none text-right font-bold text-base md:text-[11px] text-slate-400 focus:text-indigo-400 transition-colors scrollbar-hide resize-none" value={item.d} onChange={(e) => {
                                 const newArr = [...content.details.sections.manifest];
                                 newArr[idx].d = e.target.value;
                                 updateNested("details", "sections.manifest", newArr);
                             }} />
                     ...
                     <button onClick={() => {
                        ...
                        updateNested("details", "sections.manifest", newArr);
                     }} className="h-full min-h-[90px] mt-2 md:mt-0 col-span-1 w-full border-2 border-dashed border-white/10 rounded-2xl flex flex-col items-center justify-center gap-1 text-white/20 hover:text-indigo-400 hover:border-indigo-400/30 hover:bg-white/5 transition-all p-2">
                        <IoAddOutline size={18} />
                     </button>
                </div>
            </section>
