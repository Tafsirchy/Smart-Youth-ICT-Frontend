    ...
    <div className="min-h-screen bg-slate-50 p-6 max-w-7xl mx-auto pb-24 text-slate-900 selection:bg-amber-600 selection:text-white">
      ...
      <div className="flex flex-col md:flex-row justify-between items-start md:items-center gap-4 mb-8">
        <div>
          ...
          <h1 className="text-3xl font-black text-slate-900 tracking-tighter leading-none">Freelancing Career</h1>
          <p className="text-slate-400 font-bold uppercase tracking-widest text-[9px] mt-2 ml-1">Centralized Economy Node</p>
        </div>
        <button 
          onClick={handleSave}
          disabled={saving}
                        ...
                        <div key={idx} className="p-8 bg-slate-50 rounded-3xl relative group border border-transparent hover:border-amber-100 transition-all flex flex-col h-full">
                            ...
                            <div className="flex-1 space-y-4">
                                <div>
                                    ...
                                    <input placeholder="Strategic Entry" className="w-full bg-white px-4 py-2 rounded-xl border border-slate-100 outline-none font-black text-sm uppercase tracking-tighter text-slate-900" value={item.title} onChange={(e) => {
                                ...
                                <div>
                                    ...
                                    <textarea placeholder="Scientific market entry" rows="4" className="w-full bg-white px-4 py-3 rounded-xl border border-slate-100 outline-none text-[11px] text-slate-500 font-medium leading-relaxed resize-none" value={item.description} onChange={(e) => {
                                        const newArr = [...content.methodology];
