    ...
    <div className="min-h-screen bg-slate-50 p-6 max-w-7xl mx-auto pb-24 text-slate-900 selection:bg-blue-600 selection:text-white">
      ...
      <div className="flex flex-col md:flex-row justify-between items-start md:items-center gap-4 mb-8">
        <div>
          ...
          <h1 className="text-3xl font-black text-slate-900 tracking-tighter leading-none">Career Tracks</h1>
          <p className="text-slate-400 font-bold uppercase tracking-widest text-[9px] mt-2 ml-1">Centralized Roadmap Node</p>
        </div>
        <button 
          onClick={handleSave}
          disabled={saving}
            ...
            <section className="bg-white p-8 rounded-3xl border border-slate-100 shadow-lg shadow-slate-200/30">
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
                    {content.methodology?.map((item, idx) => (
                        <div key={idx} className="p-8 bg-slate-50 rounded-3xl relative group border border-transparent hover:border-blue-100 transition-all flex flex-col h-full">
                            <button onClick={() => {
                            ...
                            <div className="w-10 h-10 rounded-xl bg-blue-600 text-white flex items-center justify-center font-black text-sm mb-6 shadow-lg shadow-blue-600/20">
                            ...
                            <div className="flex-1 space-y-4">
                                <div>
                                    ...
                                    <input placeholder="Roadmap Node" className="w-full bg-white px-4 py-2 rounded-xl border border-slate-100 outline-none font-black text-sm uppercase tracking-tighter text-slate-900" value={item.title} onChange={(e) => {
                                ...
                                <div>
                                    ...
                                    <textarea placeholder="Scientific progression" rows="4" className="w-full bg-white px-4 py-3 rounded-xl border border-slate-100 outline-none text-[11px] text-slate-500 font-medium leading-relaxed resize-none" value={item.description} onChange={(e) => {
                                        const newArr = [...content.methodology];
