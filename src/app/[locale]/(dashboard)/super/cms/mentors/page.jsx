            ...
            >
              ...
              {!mentor.isActive && (
                <div className="absolute top-4 right-6">
                  <span className="text-[8px] font-black uppercase tracking-tighter bg-slate-100 text-slate-400 px-2 py-0.5 rounded-md">
                    Inactive
                  </span>
                </div>
              )}
              ...
              <h4 className="font-bold text-slate-900 truncate w-full">
                {mentor.name}
              </h4>
              <p className="text-[10px] font-black uppercase text-slate-400 tracking-wider mb-4 truncate w-full">
                {mentor.email}
              </p>
              ...
              <div className="flex flex-wrap justify-center gap-1 mb-6">
                {(mentor.expertise || []).slice(0, 3).map((e) => (
                  <span
                    key={e}
                    className="px-2 py-0.5 bg-slate-50 text-slate-500 text-[10px] font-bold rounded-lg border border-slate-100 uppercase tracking-tighter"
                  >
                    {e}
                  </span>
                ))}
      ...
      {showModal && (
        <div className="fixed inset-0 bg-slate-900/60 backdrop-blur-sm z-50 flex items-center justify-center p-4">
          <motion.div
            ...
            animate={{ opacity: 1, scale: 1 }}
            className="bg-white w-full max-w-2xl rounded-[3rem] p-10 shadow-2xl relative max-h-[95vh] overflow-y-auto"
          >
            <button
            ...
            <form onSubmit={handleSubmit} className="space-y-6">
                  ...
                  <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                    <div>
                      ...
                      <div className="relative">
                        ...
                        <input
                          required
                          className="w-full pl-11 pr-4 py-3 bg-slate-50 border-2 border-transparent focus:border-indigo-500/20 focus:bg-white transition-all rounded-xl outline-none text-sm font-bold"
                          value={formData.name}
                          onChange={(e) =>
                    ...
                    <div>
                      ...
                      <div className="relative">
                        ...
                        <input
                          ...
                          className="w-full pl-11 pr-4 py-3 bg-slate-50 border-2 border-transparent focus:border-rose-500/20 focus:bg-white transition-all rounded-xl outline-none text-sm font-bold"
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                <div>
                  <label className="text-[10px] font-black uppercase text-slate-400 mb-1 flex items-center gap-2">
                    <LuBriefcase className="w-3 h-3" /> Standard Profile Bio
                  </label>
                  <textarea
                    rows="3"
                    className="w-full px-5 py-4 bg-slate-50 border-2 border-transparent focus:border-indigo-500/20 focus:bg-white transition-all rounded-[2rem] outline-none text-sm resize-none"
                ...
                <div>
                  <label className="text-[10px] font-black uppercase text-amber-500 mb-1 flex items-center gap-2">
                    <LuStar className="w-3 h-3" /> About Us "Marketing" Bio
                  </label>
                  <textarea
                    rows="3"
                    className="w-full px-5 py-4 bg-amber-50/30 border-2 border-transparent focus:border-amber-500/20 focus:bg-amber-50/50 transition-all rounded-[2rem] outline-none text-sm resize-none"
              ...
              <div className="flex items-center justify-between p-4 bg-slate-50 rounded-2xl">
                <div className="flex items-center gap-4">
                  <label className="flex items-center gap-2 cursor-pointer group">
                    ...
                    />
                    <span className="text-[10px] font-black uppercase text-slate-500 group-hover:text-amber-500 transition-colors">
              ...
              <div className="flex gap-4 pt-6 border-t border-slate-50">
                ...
                <button
                  type="submit"
                  className="flex-[2] py-4 bg-slate-900 text-white font-black rounded-[2rem] shadow-2xl shadow-slate-900/10 hover:bg-black transition-all flex items-center justify-center gap-2"
                >
