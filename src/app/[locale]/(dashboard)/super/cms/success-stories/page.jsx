          ...
          >
            ...
            <div className="h-48 bg-slate-50 relative overflow-hidden group-hover:h-52 transition-all duration-500">
              ...
              <div className="absolute top-5 left-5">
                <div
                  className={`px-4 py-1.5 rounded-full text-[10px] font-black uppercase tracking-widest backdrop-blur-md shadow-sm flex items-center gap-2 ${story.isPublished ? "bg-white/90 text-green-600" : "bg-slate-900/80 text-white"}`}
                >
                  <div
            ...
            <form onSubmit={handleSubmit} className="space-y-6">
              <div className="flex flex-col md:flex-row gap-6">
                ...
                <div className="flex-1 space-y-4">
                  <div>
                    ...
                    <input
                      required
                      className="w-full px-4 py-3 bg-slate-50 border-2 border-transparent focus:border-indigo-500/20 focus:bg-white transition-all rounded-xl outline-none text-sm font-bold"
                  ...
                  <div>
                    ...
                    <input
                      ...
                      className="w-full px-4 py-3 bg-slate-50 border-2 border-transparent focus:border-rose-500/20 focus:bg-white transition-all rounded-xl outline-none text-sm font-bold text-rose-600"
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                <div>
                  ...
                  <select
                    required
                    className="w-full px-4 py-3 bg-slate-50 border-2 border-transparent focus:border-indigo-500/20 focus:bg-white transition-all rounded-xl outline-none text-xs font-bold"
              ...
              {formData.storyType === "text" && (
                ...
                >
                  ...
                  <textarea
                    rows="3"
                    required
                    className="w-full px-4 py-3 bg-slate-50 border-2 border-transparent focus:border-indigo-500/20 focus:bg-white transition-all rounded-xl outline-none text-sm resize-none"
