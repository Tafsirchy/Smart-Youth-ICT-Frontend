      ...
      >
        ...
        <div>
          ...
          <p className="text-indigo-200 text-base mb-8 leading-relaxed">
            Learn practical skills, work on real projects, and earn from day
            one.
          </p>
          ...
          {GOOGLE_AUTH_ENABLED && (
            <>
              <button
                ...
                className="mb-5 flex w-full items-center justify-center gap-3 rounded-xl border border-neutral-300 bg-white px-4 py-3 text-sm font-semibold text-neutral-800 transition hover:border-neutral-400 disabled:opacity-60"
              >
                <FaGoogle size={18} />
                {googleLoading
            ...
            <div>
              ...
              <div className="relative">
                <input
                  ...
                  required
                  className={`input w-full pr-11 ${errors.password ? "border-red-400" : ""}`}
                ...
                <ul className="mt-2 space-y-1">
                  {PW_RULES.map((r) => {
                    ...
                    return (
                      <li
                        key={r.label}
                        className={`flex items-center gap-1.5 text-xs ${ok ? "text-emerald-600" : "text-neutral-400"}`}
                      >
                        {ok ? (
