...
export default function CareerTracksDetailsPage() {
  ...
  useEffect(() => {
    const fetchData = async () => {
      try {
        ...
        console.error("Failed to load career tracks details", err);
      } finally {
        setLoading(false);
      }
    };
  ...
  if (loading) return <div className="min-h-screen bg-slate-50 flex items-center justify-center font-black animate-pulse text-indigo-600">LOADING CAREER MANIFEST...</div>;
      ...
      <div className="container-custom pt-20">
        ...
        <div className="grid lg:grid-cols-2 gap-20 items-start mb-48">
           <div className="sticky top-32">
              ...
              <h2 className="text-5xl font-black text-slate-900 mb-8 tracking-tighter">Bespoke <br/> Career <span className="text-indigo-600">Architecture.</span></h2>
              <p className="text-slate-500 text-lg font-light leading-relaxed mb-12">We treat your professional growth as a high-fidelity development project, focusing on the specific KPI signals that hiring managers track.</p>
           ...
           <div className="space-y-6">
              {roi.map((spec, idx) => (
                 <div key={idx} className="bg-white rounded-[2.5rem] p-10 border border-slate-200 shadow-sm hover:shadow-xl transition-all">
                    <h4 className="text-[10px] font-black text-indigo-600 uppercase tracking-[0.4em] mb-8">{spec.group} Framework</h4>
        ...
        <div className="bg-white rounded-[4rem] p-12 lg:p-24 border border-slate-100 shadow-2xl shadow-slate-200/50 relative overflow-hidden mb-48">
           ...
           <div className="grid lg:grid-cols-2 gap-20 relative z-10">
              <div>
                 ...
                 <h2 className="text-5xl font-black text-slate-900 mb-8 leading-[0.9]">Absolute <br/><span className="text-indigo-600">Trajectory.</span></h2>
                 <p className="text-slate-500 text-lg font-light leading-relaxed mb-12 italic">"A career isn't just about what you know; it's about how you position that knowledge. We architect your professional brand to be irresistible to elite firms."</p>
              ...
              <div className="relative">
                 <div className="bg-slate-900 rounded-[3rem] p-10 border border-slate-800 shadow-2xl aspect-[3/4] flex flex-col justify-between group overflow-hidden">
                    ...
                    <div className="space-y-8 relative z-10">
                       ...
                       <div className="space-y-4">
                          ...
                          <div className="flex items-center gap-4">
                             <div className="w-12 h-12 rounded-xl bg-white/5 border border-white/10 flex items-center justify-center text-indigo-400 font-black text-xs"><IoTrendingUpOutline /></div>
                       ...
                       <div className="p-6 bg-white/5 rounded-2xl border border-white/5">
                          <p className="text-[8px] font-mono text-emerald-400 mb-2 tracking-tighter">PLACEMENT_READY::VERIFIED</p>
                    ...
                    <div className="bg-white/5 rounded-3xl border border-white/10 p-8 relative overflow-hidden group/m hover:bg-white/10 transition-all">
                       <IoPulseOutline className="text-4xl text-indigo-600/30 mb-4 group-hover/m:rotate-12 transition-transform shadow-[0_0_20px_rgba(79,70,229,0.2)]" />
                       <p className="text-[9px] font-black text-white/50 uppercase tracking-widest mb-2">Protocol: CAREER_QA_CLEAR</p>
        ...
        <div className="text-center py-40 border-t border-slate-200">
           <IoBriefcaseOutline className="text-7xl text-indigo-600 mb-12 mx-auto opacity-20" />
           <h3 className="text-5xl lg:text-7xl font-black text-slate-900 mb-12 leading-tight">Ready to activate your <br/><span className="text-transparent bg-clip-text bg-gradient-to-r from-indigo-600 to-violet-700 font-serif italic font-medium">Professional Identity?</span></h3>
