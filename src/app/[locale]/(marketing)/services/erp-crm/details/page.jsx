    ...
    <section className="min-h-screen bg-slate-50 text-slate-900 selection:bg-teal-600 pb-40">
      ...
      <div className="container-custom pt-24 text-slate-900">
        ...
        <div className="max-w-5xl mb-40 px-4 md:px-0">
           ...
           >
             Industrial <br/> <span className="text-transparent bg-clip-text bg-gradient-to-r from-teal-600 via-emerald-500 to-teal-700 font-serif italic font-light">Ecosystem.</span>
           </motion.h1>
