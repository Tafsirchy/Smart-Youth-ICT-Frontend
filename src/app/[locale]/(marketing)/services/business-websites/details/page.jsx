...
export default function BusinessDetailsPage() {
  ...
  if (loading) return <div className="min-h-screen bg-white flex items-center justify-center font-black animate-pulse text-blue-400 uppercase tracking-widest">ACTIVATING DETAIL PROTOCOL...</div>;
  if (!data) return null;
