...
export default function BusinessDetailsPage() {
  ...
  return (
    <section className="min-h-screen bg-[#020617] text-white selection:bg-blue-600 pb-40">
      ...
      <div className="border-b border-white/5 sticky top-0 bg-black/80 backdrop-blur-xl z-50">
         <div className="container-custom py-6 flex justify-between items-center">
            <Link href="/services/business-websites" className="flex items-center gap-2 text-slate-500 hover:text-blue-500 font-bold transition-all group">
            ...
            <div className="flex items-center gap-4 bg-white/5 px-4 py-2 rounded-lg border border-white/10">
               ...
               <p className="text-[10px] font-black uppercase tracking-[0.3em] text-slate-400">Security Level: Enterprise</p>
            </div>
         </div>
      </div>
      ...
      <div className="container-custom pt-24">
        ...
        <div className="max-w-5xl mb-40">
           <motion.div 
             ...
             className="inline-flex items-center gap-3 px-6 py-2 rounded-lg bg-blue-600/10 border border-blue-500/20 text-blue-400 text-[10px] font-black uppercase tracking-[0.4em] mb-12"
           >
           ...
           >
             Operational <br/> <span className="text-transparent bg-clip-text bg-gradient-to-r from-blue-500 via-cyan-400 to-indigo-500 font-serif italic font-light italic">Architecture.</span>
           </motion.h1>
        ...
        <div className="grid lg:grid-cols-2 gap-12 mb-48">
           <div className="bg-white/5 rounded-[4rem] p-12 lg:p-20 border border-white/5 relative overflow-hidden group">
              <IoStatsChartOutline className="text-5xl text-blue-500 mb-8" />
              <h3 className="text-3xl font-black text-white mb-6">ROI Convergence</h3>
              ...
              <ul className="space-y-4">
                 {["Behavioral Heatmapping", "Zero-Friction Forms", "Fast-Action CTAs"].map(item => (
                    <li key={item} className="flex gap-3 items-center text-sm font-bold text-slate-500">
           ...
           <div className="bg-white/5 rounded-[4rem] p-12 lg:p-20 border border-white/5 relative overflow-hidden group">
              ...
              <h3 className="text-3xl font-black text-white mb-6">Technical Integrity</h3>
              <p className="text-slate-400 font-light leading-relaxed text-lg mb-10">
        ...
        <div className="mb-48">
           <div className="max-w-xl mb-16">
              ...
              <p className="text-4xl font-black text-white leading-tight">Engine Specification <span className="text-slate-700">Database.</span></p>
           </div>
           
           <div className="grid md:grid-cols-2 gap-1 px-8 lg:px-0 bg-white/5 border border-white/10 rounded-[3rem] overflow-hidden">
              {engineSpecs.map((spec, idx) => (
                 <div key={idx} className="p-10 border-b border-r border-white/5 flex flex-col justify-between hover:bg-white/5 transition-colors group">
                    <p className="text-[10px] font-black text-slate-500 uppercase tracking-[0.3em] mb-4">{spec.label}</p>
                    <p className="text-xl font-bold text-white group-hover:text-blue-400 transition-colors">{spec.value}</p>
                 </div>
              ))}
           </div>
        </div>
        ...
        <div className="bg-slate-950 rounded-[5rem] p-12 lg:p-24 border border-blue-500/20 relative overflow-hidden">
           <div className="absolute top-0 right-0 w-2/3 h-full bg-blue-600/5 -skew-x-[20deg] origin-top translate-x-1/2"></div>
           
           <div className="relative z-10">
              <div className="flex flex-col lg:flex-row justify-between items-start gap-12 mb-20">
                 <div className="max-w-2xl">
                    <h2 className="text-5xl lg:text-7xl font-black text-white leading-tight mb-8">Corporate <br/> <span className="font-serif italic font-light italic text-blue-500">Readiness.</span></h2>
                    <p className="text-slate-400 text-xl font-light leading-relaxed">To ensure high-fidelity delivery, our architects require the following data artifacts before the discovery sprint begins.</p>
                 </div>
              ...
              <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-6">
                 {corporateChecklist.map((item, idx) => (
                    <div key={idx} className="bg-black/60 p-10 rounded-[2.5rem] border border-white/5 hover:border-blue-500/30 transition-all group">
                       <h4 className="font-bold text-white mb-4 group-hover:text-blue-500 transition-colors">{item.t}</h4>
        ...
        {/* CALL TO ORDER */}
        <div className="mt-48 text-center bg-blue-600 rounded-[4rem] py-32 relative overflow-hidden group">
           <div className="relative z-10 flex flex-col items-center">
              <IoGitNetworkOutline className="text-8xl text-white opacity-20 mb-12 animate-pulse" />
              <h3 className="text-5xl lg:text-7xl font-black text-white mb-12 leading-tight">Initialize Your <br/><span className="font-serif italic font-light italic text-blue-200">Corporate Presence.</span></h3>
