...
export default function SkillDevelopmentDetailsPage() {
  ...
  useEffect(() => {
    const fetchData = async () => {
      try {
        ...
        console.error("Failed to load skill development details", err);
      } finally {
        setLoading(false);
      }
    };
  ...
  if (loading) return <div className="min-h-screen bg-slate-50 flex items-center justify-center font-black animate-pulse text-blue-600">LOADING PEDAGOGICAL MANIFEST...</div>;
    ...
    <section className="min-h-screen bg-slate-50 text-slate-900 selection:bg-blue-600 selection:text-white pb-40">
      ...
      <div className="border-b border-slate-200 bg-white/80 backdrop-blur-md sticky top-0 z-50">
        <div className="container-custom py-4 flex items-center justify-between">
          <Link href="/services/skill-development" className="flex items-center gap-2 text-[10px] font-black uppercase tracking-widest text-slate-400 hover:text-blue-600 transition-colors">
            <IoArrowBackOutline className="text-sm" /> Product Architecture
          </Link>
          <div className="text-[10px] font-black uppercase tracking-[0.4em] text-blue-600">EDU_SPEC_v6.8</div>
        </div>
      </div>
      ...
      <div className="container-custom pt-20">
        ...
        <div className="mb-48">
          <div className="flex items-center gap-8 mb-20">
             <h2 className="text-3xl font-black text-slate-900 tracking-tighter uppercase leading-none">The Learning Lifecycle</h2>
        ...
        <div className="grid lg:grid-cols-2 gap-20 items-start mb-48">
           <div className="sticky top-32">
              ...
              <h2 className="text-5xl font-black text-slate-900 mb-8 tracking-tighter">Curriculum <br/> Persistence <span className="text-blue-600">Logic.</span></h2>
              <p className="text-slate-500 text-lg font-light leading-relaxed mb-12">Every module is stress-tested against current industry requirements, ensuring that you're learning exactly what high-value companies are hiring for today.</p>
              ...
              <div className="p-8 bg-slate-900 rounded-3xl border border-slate-800 shadow-2xl flex items-center justify-between group cursor-default">
                 <div className="flex gap-4 items-center">
                    <div className="w-12 h-12 rounded-xl bg-blue-500 flex items-center justify-center text-white shadow-lg"><IoCodeWorkingOutline className="text-2xl" /></div>
                    <div>
                       <p className="text-[10px] font-black text-white/40 uppercase tracking-widest">Pedagogical Audit</p>
                       <p className="text-xs font-bold text-white tracking-tight">VETTING_STATUS::100%_CLEARED</p>
                    </div>
                 </div>
           ...
           <div className="grid lg:grid-cols-2 gap-20 relative z-10">
              <div>
                 <div className="text-blue-600 mb-8 flex items-center gap-4">
                    ...
                    <span className="text-[10px] font-black uppercase tracking-[0.4em]">Expert Validation Mesh</span>
                 </div>
                 <h2 className="text-5xl font-black text-slate-900 mb-8 leading-[0.9]">Absolute <br/><span className="text-blue-600">Instruction.</span></h2>
                 <p className="text-slate-500 text-lg font-light leading-relaxed mb-12 italic">"We don't just provide content; we provide persistent oversight. Your code and projects are reviewed by our senior board to ensure adherence to global standards."</p>
              ...
              <div className="relative">
                 <div className="bg-slate-900 rounded-[3rem] p-10 border border-slate-800 shadow-2xl aspect-[3/4] flex flex-col justify-between group overflow-hidden">
                    ...
                    <div className="space-y-8 relative z-10">
                       ...
                       <div className="space-y-4">
                          ...
                          <div className="flex items-center gap-4">
                             <div className="w-12 h-12 rounded-xl bg-white/5 border border-white/10 flex items-center justify-center text-blue-400 font-black text-xs"><IoTerminalOutline /></div>
                       ...
                       <div className="p-6 bg-white/5 rounded-2xl border border-white/5">
                          <p className="text-[8px] font-mono text-emerald-400 mb-2 tracking-tighter">LEARNING_SYNC::STABLE</p>
                          <p className="text-[8px] font-mono text-slate-500 leading-tight">MEMBER_SCORE: 100/100<br/>VETTING_ID: EDU_7291<br/>STATUS: VERIFIED</p>
                       </div>
                    </div>
                    ...
                    <div className="bg-white/5 rounded-3xl border border-white/10 p-8 relative overflow-hidden group/m hover:bg-white/10 transition-all">
                       <IoPulseOutline className="text-4xl text-blue-600/30 mb-4 group-hover/m:rotate-12 transition-transform shadow-[0_0_20px_rgba(37,99,235,0.2)]" />
                       <p className="text-[9px] font-black text-white/50 uppercase tracking-widest mb-2">Protocol: PEDAGOGY_QA_CLEAR</p>
                       <p className="text-xs font-bold text-white tracking-tight">Skill base ready for deployment.</p>
        ...
        <div className="text-center py-40 border-t border-slate-200">
           ...
           <h3 className="text-5xl lg:text-7xl font-black text-slate-900 mb-12 leading-tight">Ready to activate your <br/><span className="text-transparent bg-clip-text bg-gradient-to-r from-blue-600 to-indigo-600 font-serif italic font-medium">Knowledge Sovereignty?</span></h3>
