...
export default function FreelancingDetailsPage() {
  ...
  useEffect(() => {
    const fetchData = async () => {
      try {
        ...
        console.error("Failed to load freelancing details", err);
      } finally {
        setLoading(false);
      }
    };
  ...
  if (loading) return <div className="min-h-screen bg-slate-50 flex items-center justify-center font-black animate-pulse text-amber-600">LOADING MARKET MANIFEST...</div>;
    ...
    <section className="min-h-screen bg-slate-50 text-slate-900 selection:bg-amber-600 selection:text-white pb-40">
      ...
      <div className="border-b border-slate-200 bg-white/80 backdrop-blur-md sticky top-0 z-50">
        <div className="container-custom py-4 flex items-center justify-between">
          <Link href="/services/freelancing" className="flex items-center gap-2 text-[10px] font-black uppercase tracking-widest text-slate-400 hover:text-amber-600 transition-colors">
            <IoArrowBackOutline className="text-sm" /> Independence Overview
          </Link>
          <div className="text-[10px] font-black uppercase tracking-[0.4em] text-amber-600">MARKET_SPEC_v2.4</div>
        </div>
      </div>
      ...
      <div className="container-custom pt-20">
        ...
        <div className="mb-48">
          <div className="flex items-center gap-8 mb-20">
             <h2 className="text-3xl font-black text-slate-900 tracking-tighter uppercase leading-none">The Independence Lifecycle</h2>
        ...
        <div className="grid lg:grid-cols-2 gap-20 items-start mb-48">
           <div className="sticky top-32">
              ...
              <h2 className="text-5xl font-black text-slate-900 mb-8 tracking-tighter">Monetization <br/> Sovereignty <span className="text-amber-600">Manifest.</span></h2>
              <p className="text-slate-500 text-lg font-light leading-relaxed mb-12">Building a freelance career is building a business. We provide the architectural blueprints for high-vibration client acquisition and persistent revenue growth.</p>
              ...
              <div className="p-8 bg-slate-900 rounded-3xl border border-slate-800 shadow-2xl flex items-center justify-between group cursor-default">
                 <div className="flex gap-4 items-center">
                    <div className="w-12 h-12 rounded-xl bg-amber-500 flex items-center justify-center text-white shadow-lg"><IoBriefcaseOutline className="text-2xl" /></div>
                    <div>
                       <p className="text-[10px] font-black text-white/40 uppercase tracking-widest">Revenue Audit</p>
                       <p className="text-xs font-bold text-white tracking-tight">STATUS::TOP_RATED_CLEAR</p>
                    </div>
                 </div>
           ...
           <div className="grid lg:grid-cols-2 gap-20 relative z-10">
              <div>
                 <div className="text-amber-600 mb-8 flex items-center gap-4">
                    ...
                    <span className="text-[10px] font-black uppercase tracking-[0.4em]">Global Marketplace Sync</span>
                 </div>
                 <h2 className="text-5xl font-black text-slate-900 mb-8 leading-[0.9]">Absolute <br/><span className="text-amber-600">Monetization.</span></h2>
                 <p className="text-slate-500 text-lg font-light leading-relaxed mb-12 italic">"The feed is competitive, but it's not random. We teach you the mathematical approach to bidding that guarantees high-vibration client resonance."</p>
              ...
              <div className="relative">
                 <div className="bg-slate-900 rounded-[3rem] p-10 border border-slate-800 shadow-2xl aspect-[3/4] flex flex-col justify-between group overflow-hidden">
                    ...
                    <div className="space-y-8 relative z-10">
                       ...
                       <div className="space-y-4">
                          ...
                          <div className="flex items-center gap-4">
                             <div className="w-12 h-12 rounded-xl bg-white/5 border border-white/10 flex items-center justify-center text-amber-400 font-black text-xs"><IoRocketOutline /></div>
                       ...
                       <div className="p-6 bg-white/5 rounded-2xl border border-white/5">
                          <p className="text-[8px] font-mono text-emerald-400 mb-2 tracking-tighter">BID_STRENGTH::OPTIMIZED_HIGH</p>
                          <p className="text-[8px] font-mono text-slate-500 leading-tight">AVG_HOURLY: $45.00<br/>SUCCESS_RATE: 98%<br/>STATUS: TOP_RATED</p>
                       </div>
                    </div>
                    ...
                    <div className="bg-white/5 rounded-3xl border border-white/10 p-8 relative overflow-hidden group/m hover:bg-white/10 transition-all">
                       <IoPulseOutline className="text-4xl text-amber-600/30 mb-4 group-hover/m:rotate-12 transition-transform shadow-[0_0_20px_rgba(217,119,6,0.2)]" />
                       <p className="text-[9px] font-black text-white/50 uppercase tracking-widest mb-2">Protocol: MARKET_QA_CLEAR</p>
                       <p className="text-xs font-bold text-white tracking-tight">Profile ready for activation.</p>
        ...
        <div className="text-center py-40 border-t border-slate-200">
           <IoStorefrontOutline className="text-7xl text-amber-600 mb-12 mx-auto opacity-20" />
           <h3 className="text-5xl lg:text-7xl font-black text-slate-900 mb-12 leading-tight">Ready to command your <br/><span className="text-transparent bg-clip-text bg-gradient-to-r from-amber-600 to-rose-700 font-serif italic font-medium">Independent Sovereignty?</span></h3>
