      ...
      <section className="min-h-screen bg-slate-50 text-slate-900 selection:bg-blue-600 selection:text-white overflow-hidden relative font-sans">
         ...
         <div className="container-custom py-20 relative z-10">
            ...
            <div className="text-center py-40 border-t border-slate-200">
               ...
               <h3 className="text-5xl lg:text-6xl font-black text-slate-900 mb-12 leading-tight">Scale your digital footprint. <br /><span className="text-transparent bg-clip-text bg-gradient-to-r from-blue-600 to-indigo-600 font-serif italic font-medium">Command the Infrastructure.</span></h3>
