  ...
  return (
    <section className="min-h-screen bg-[#fafafa] overflow-hidden relative selection:bg-rose-500 selection:text-white">
      ...
      <div className="container-custom py-20 relative">
        ...
        <div className="flex flex-col lg:flex-row items-center gap-16 mb-40 pt-10 px-4 md:px-0">
        ...
        <div className="text-center py-40 border-t border-slate-100 mt-20 relative overflow-hidden rounded-[5rem] bg-white mx-4 md:mx-0">
