      ...
      <div className="container-custom py-20 relative z-10">
        ...
        {data?.placements?.length > 0 ? (
            ...
            <div className="grid lg:grid-cols-3 gap-8 max-w-7xl mx-auto">
              {data.placements.map((p, i) => (
                ...
                >
                  ...
                  <div
                    className={`w-16 h-16 rounded-2xl ${p.color} text-white flex items-center justify-center text-3xl mb-8 shadow-2xl`}
                  >
                    <IoBriefcaseOutline />
                  </div>
          ...
          <div className="text-center py-20 bg-white/5 rounded-[3rem] border border-white/10 mb-32 flex flex-col items-center">
            ...
            <p className="text-white/40 font-black uppercase tracking-widest leading-none">
              Job Channels Ready
            </p>
          </div>
        )}
        ...
        {data?.lifecycle?.length > 0 && (
          <div className="mb-32 max-w-5xl mx-auto">
            <h2 className="text-4xl lg:text-5xl font-black text-white text-center mb-20 leading-tight">
        ...
        >
          ...
          <div className="flex-1 space-y-8 relative z-10">
            ...
            <h2 className="text-4xl lg:text-5xl font-black text-slate-900 leading-tight tracking-tighter uppercase italic">
              Career Launch <br />
              Labs.
            </h2>
