...
export default function UiUxDetailsClient({ data }) {
  ...
  return (
    <section className="min-h-screen bg-slate-50 text-slate-900 selection:bg-cyan-600 selection:text-white pb-12 md:pb-20 relative font-sans flex flex-col">
      ...
      <div className="container-custom pt-6 md:pt-10 pb-[max(3rem,env(safe-area-inset-bottom))] md:pb-0">
        <div className="max-w-5xl mb-12 md:mb-16 relative">
          <motion.div initial={{ opacity: 0 }} animate={{ opacity: 1 }} className="flex items-center gap-3 md:gap-4 text-cyan-600 mb-4 md:mb-6">
          ...
          <div className="flex flex-col md:flex-row gap-8 md:gap-12 items-start mt-8 md:mt-12">
            <div className="flex-1">
              ...
              <div className="h-1 w-12 md:w-20 bg-cyan-600/20" />
            </div>
            <div className="w-full md:w-80 bg-white p-6 md:p-8 rounded-2xl md:rounded-3xl border border-slate-100 shadow-xl">
              <h4 className="text-[10px] font-black text-slate-400 uppercase tracking-widest mb-4 md:mb-6 px-1 leading-[1.4]">Cognitive Pulse</h4>
        ...
        <div className="mb-12 lg:mb-24">
          <div className="flex items-center gap-4 md:gap-6 mb-8 md:mb-12">
            <h2 className="text-2xl md:text-3xl font-black text-slate-900 tracking-tighter uppercase leading-[1.1] italic">The Design Protocol</h2>
        ...
        <div className="mb-12 lg:mb-24">
          <div className="flex flex-col md:flex-row gap-6 md:gap-8 items-baseline mb-8 md:mb-12">
            <h2 className="text-[10px] font-black text-cyan-600 uppercase tracking-[0.4em] border-l-4 border-cyan-600 pl-3 md:pl-4 leading-[1.4]">Architectural Frameworks</h2>
          </div>
          ...
          <div className="grid lg:grid-cols-3 gap-4 md:gap-8">
            {(sections.roi || []).map((group, idx) => (
              <div key={idx} className="bg-white rounded-2xl md:rounded-[3rem] p-6 md:p-10 border border-slate-100 shadow-xl shadow-slate-200/50 hover:shadow-2xl transition-all group">
                <div className="w-10 h-10 md:w-12 md:h-12 bg-cyan-50 rounded-xl flex items-center justify-center text-xl md:text-2xl text-cyan-600 mb-6 md:mb-8 group-hover:scale-110 transition-transform"><IoFlashOutline /></div>
        ...
        <div className="text-center py-12 lg:py-20 border-t border-slate-200">
          <IoSparklesOutline className="text-5xl lg:text-7xl text-cyan-600 mb-6 md:mb-8 mx-auto opacity-20" />
          ...
          <div className="flex flex-col sm:flex-row gap-3 md:gap-4 justify-center">
            <button className="w-full sm:w-[240px] min-h-[48px] px-4 py-3 md:py-4 bg-cyan-600 text-white font-black rounded-xl hover:bg-cyan-700 transition-all shadow-xl shadow-cyan-600/40 uppercase tracking-widest text-[10px] flex items-center justify-center leading-[1.4]">
      ...
      <div className="sticky bottom-0 left-0 w-full p-[var(--gutter,16px)] bg-white/90 backdrop-blur-md border-t border-slate-100 z-50 md:hidden flex items-center justify-between shadow-[0_-10px_40px_rgba(0,0,0,0.05)] pb-[max(1rem,env(safe-area-inset-bottom))] mt-auto">
         ...
         <button className="px-5 py-3 min-h-[48px] bg-cyan-600 text-white font-black rounded-xl text-[10px] uppercase tracking-widest shadow-md shadow-cyan-600/30 leading-[1.4] flex items-center justify-center">
            Initialize Audit
         </button>
      </div>
    </section>
