...
export default function ChatbotDetailsClient({ data }) {
   if (!data) return null;
      ...
      <section className="min-h-screen bg-slate-50 text-slate-900 selection:bg-emerald-600 selection:text-white pb-12 md:pb-20 relative font-sans flex flex-col">
         ...
         <div className="border-b border-slate-200 bg-white/80 backdrop-blur-md sticky top-0 z-50">
            <div className="container-custom py-2 md:py-3 flex items-center justify-between">
               ...
               <div className="text-[10px] font-black uppercase tracking-[0.4em] text-emerald-600">{hero.subtitle}</div>
            </div>
         </div>
         ...
         <div className="container-custom pt-6 md:pt-10 pb-[max(3rem,env(safe-area-inset-bottom))] md:pb-0">
            ...
            <div className="max-w-5xl mb-12 md:mb-16 relative">
               <motion.div
                  initial={{ opacity: 0 }}
                  animate={{ opacity: 1 }}
                  className="flex items-center gap-3 md:gap-4 text-emerald-600 mb-4 md:mb-6"
               >
            ...
            <div className="mb-12 lg:mb-24">
               <div className="flex items-center gap-4 md:gap-6 mb-8 md:mb-12">
                  <h2 className="text-2xl md:text-3xl font-black text-slate-900 tracking-tighter uppercase leading-[1.1] italic">Training Lifecycle</h2>
               ...
               <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-px bg-slate-200 border border-slate-200 rounded-2xl md:rounded-[3rem] overflow-hidden shadow-2xl">
                  {(sections.phases || []).map((item, i) => (
                     <div key={i} className="bg-white p-6 md:p-10 hover:bg-slate-50 transition-colors group">
                        ...
                        <h3 className="text-lg md:text-xl font-black text-slate-900 mb-2 md:mb-4 tracking-tight group-hover:text-emerald-600 transition-colors uppercase leading-[1.4]">{item.stage}</h3>
            ...
            <div className="grid lg:grid-cols-2 gap-8 lg:gap-16 items-start mb-12 lg:mb-24">
               <div className="relative lg:sticky lg:top-32 mb-8 lg:mb-0">
                  <div className="w-12 h-12 md:w-16 md:h-16 bg-emerald-50 rounded-xl md:rounded-2xl flex items-center justify-center text-2xl md:text-3xl text-emerald-600 mb-6 md:mb-8 border border-emerald-100">
                     <IoHardwareChipOutline />
                  </div>
                  ...
                  <div className="p-6 md:p-8 bg-slate-900 rounded-2xl md:rounded-3xl border border-slate-800 shadow-2xl flex items-center justify-between group cursor-default">
                     <div className="flex gap-3 md:gap-4 items-center">
                        <div className="w-10 h-10 md:w-12 md:h-12 rounded-xl bg-emerald-500 flex items-center justify-center text-white shadow-lg"><IoGitNetworkOutline className="text-xl md:text-2xl" /></div>
                        <div>
                        ...
                        <div className="grid grid-cols-2 gap-3 md:gap-4">
                           {spec.items?.map(item => (
                              <div key={item} className="flex items-center gap-2 md:gap-3 text-xs md:text-sm font-bold text-slate-600 leading-[1.4]">
                                 <IoCheckmarkCircleOutline className="text-emerald-600 text-base md:text-lg shrink-0" /> 
                                 <span>{item}</span>
                              </div>
                           ))}
                        </div>
               ...
               <div className="grid lg:grid-cols-2 gap-8 md:gap-12 lg:gap-20 relative z-10">
                  <div>
                     <div className="text-emerald-600 mb-4 md:mb-6 flex items-center gap-3 md:gap-4">
                        ...
                        <span className="text-[10px] font-black uppercase tracking-[0.4em] leading-[1.4]">Integrity Governance</span>
                     </div>
                     <h2 className="text-3xl md:text-5xl font-black text-slate-900 mb-4 md:mb-6 leading-[1.1]">Trusted <br /><span className="text-emerald-600">Decision Systems.</span></h2>
                     <p className="text-slate-500 text-base md:text-lg font-light leading-[1.6] mb-6 md:mb-8 italic">"We implement multi-layered prompt injection shielding and PII redaction to ensure your AI behaves with corporate-grade integrity."</p>
                        ...
                        <div className="space-y-6 md:space-y-8 relative z-10 mb-8 md:mb-0">
                           ...
                           <div className="space-y-4">
                              ...
                              <div className="flex items-center gap-3 md:gap-4">
                                 <div className="w-10 h-10 md:w-12 md:h-12 rounded-xl bg-white/5 border border-white/10 flex items-center justify-center text-emerald-400 font-black text-xs shrink-0"><IoAnalyticsOutline /></div>
