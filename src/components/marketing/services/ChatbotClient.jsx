    ...
    <section className="min-h-screen bg-slate-50 text-slate-900 selection:bg-emerald-600 selection:text-white overflow-hidden relative font-sans">
      ...
      <div className="container-custom py-20 relative z-10">
        ...
        <div className="mb-48 px-4 md:px-0">
          <div className="grid lg:grid-cols-2 gap-20 items-center bg-white rounded-[4rem] p-12 lg:p-24 border border-slate-100 shadow-2xl shadow-slate-200/50 relative overflow-hidden">
            ...
            <div className="relative z-10 space-y-12">
              ...
              <h2 className="text-5xl lg:text-6xl font-black text-slate-900 leading-[0.9]">Multi-Channel <br /><span className="text-emerald-600">Omni-Sync.</span></h2>
              ...
              <div className="grid grid-cols-2 gap-px bg-slate-50 border border-slate-100 rounded-3xl overflow-hidden mt-10">
                {(data.sections.integrations || []).map((item, idx) => (
                  <div key={idx} className="p-10 hover:bg-white transition-colors group">
                    <h4 className="text-[10px] font-black text-emerald-600 uppercase tracking-widest mb-2">{item.t}</h4>
        ...
        <div className="text-center py-40 border-t border-slate-200 px-4 md:px-0">
          ...
          <h3 className="text-5xl lg:text-6xl font-black text-slate-900 mb-12 leading-tight">Your team doesn't sleep. <br /><span className="text-transparent bg-clip-text bg-gradient-to-r from-emerald-600 to-blue-500 font-serif italic font-medium">{data.cta.title?.split(' ')[0]} {data.cta.title?.split(' ').slice(1).join(' ')}.</span></h3>
