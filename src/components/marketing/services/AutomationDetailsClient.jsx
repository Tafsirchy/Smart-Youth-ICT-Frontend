         ...
         <div className="container-custom pt-20">
            ...
            <div className="mb-48 px-4 md:px-0">
               <div className="flex items-center gap-8 mb-20">
                  <h2 className="text-3xl font-black text-slate-900 tracking-tighter uppercase leading-none">Implementation Lifecycle</h2>
            ...
            <div className="grid lg:grid-cols-2 gap-20 items-start mb-48 px-4 md:px-0">
               <div className="sticky top-32">
                  ...
                  <h2 className="text-5xl font-black text-slate-900 mb-8 tracking-tighter">Logic <br /> Node <span className="text-amber-600">Specifications.</span></h2>
                  <p className="text-slate-500 text-lg font-light leading-relaxed mb-12">Every automation workflow is built on a resilient node-based architecture. This allows your business to scale complex logic without increasing manual oversight.</p>
                  ...
                  <div className="p-8 bg-slate-900 rounded-3xl border border-slate-800 shadow-2xl flex items-center justify-between group cursor-default">
                     <div className="flex gap-4 items-center">
                        ...
                        <div>
                           <p className="text-[10px] font-black text-white/40 uppercase tracking-widest">Workflow Audit</p>
                           <p className="text-xs font-bold text-white tracking-tight">LATENCY_SYNC::SUB_2S</p>
                        </div>
                     </div>
               ...
               <div className="grid lg:grid-cols-2 gap-20 relative z-10">
                  <div>
                     <div className="text-amber-600 mb-8 flex items-center gap-4">
                        ...
                        <span className="text-[10px] font-black uppercase tracking-[0.4em]">Efficiency Attribution</span>
                     </div>
                     <h2 className="text-5xl font-black text-slate-900 mb-8 leading-[0.9]">Attributable <br /><span className="text-amber-600">Resource Gain.</span></h2>
                     <p className="text-slate-500 text-lg font-light leading-relaxed mb-12 italic">"We don't just 'make' workflows. We architect efficiency engines that yield measurable ROI across your entire operation."</p>
                  ...
                  <div className="relative">
                     <div className="bg-slate-900 rounded-[3rem] p-10 border border-slate-800 shadow-2xl aspect-[3/4] flex flex-col justify-between group overflow-hidden">
                        ...
                        <div className="space-y-8 relative z-10">
                           ...
                           <div className="space-y-4">
                              ...
                              <div className="flex items-center gap-4">
                                 <div className="w-12 h-12 rounded-xl bg-white/5 border border-white/10 flex items-center justify-center text-amber-400 font-black text-xs"><IoFlashOutline /></div>
                           ...
                           <div className="p-6 bg-white/5 rounded-2xl border border-white/5">
                              <p className="text-[8px] font-mono text-emerald-400 mb-2 tracking-tighter">DATA_BRIDGE::STABLE</p>
                              <p className="text-[8px] font-mono text-slate-500 leading-tight">SRC: SHOPIFY_V3<br />DEST: G-SHEETS_API<br />MAP: CUSTOM_JSON</p>
                           </div>
                        </div>
                        ...
                        <div className="bg-white/5 rounded-3xl border border-white/10 p-8 relative overflow-hidden group/m hover:bg-white/10 transition-all">
                           <IoCloudDoneOutline className="text-4xl text-amber-600/30 mb-4 group-hover/m:rotate-12 transition-transform" />
            ...
            <div className="text-center py-40 border-t border-slate-200 px-4 md:px-0">
               <IoPulseOutline className="text-7xl text-amber-600 mb-12 mx-auto opacity-20" />
               <h3 className="text-5xl lg:text-6xl font-black text-slate-900 mb-12 leading-tight">Ready to activate your <br /><span className="text-transparent bg-clip-text bg-gradient-to-r from-amber-600 to-indigo-600 font-serif italic font-medium">Efficiency Engines?</span></h3>
