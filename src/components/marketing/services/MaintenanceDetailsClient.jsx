...
export default function MaintenanceDetailsClient({ data }) {
   ...
   return (
      <section className="min-h-screen bg-slate-50 text-slate-900 selection:bg-teal-600 selection:text-white pb-12 md:pb-20 relative font-sans flex flex-col">
         ...
         <div className="container-custom pt-6 md:pt-10 pb-[max(3rem,env(safe-area-inset-bottom))] md:pb-0">
            ...
            <div className="max-w-5xl mb-12 md:mb-16 relative">
               <motion.div
                  initial={{ opacity: 0 }}
                  animate={{ opacity: 1 }}
                  className="flex items-center gap-3 md:gap-4 text-teal-600 mb-4 md:mb-6"
               >
               ...
               <div className="mt-8 md:mt-12">
                  ...
                  <div className="h-1 w-12 md:w-20 bg-teal-600/20" />
               </div>
            </div>
            ...
            <div className="mb-12 lg:mb-24">
               <div className="flex items-center gap-4 md:gap-6 mb-8 md:mb-12">
                  <h2 className="text-2xl md:text-3xl font-black text-slate-900 tracking-tighter uppercase leading-[1.1] italic">The Maintenance Protocol</h2>
               ...
               <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-px bg-slate-200 border border-slate-200 rounded-2xl md:rounded-[3rem] overflow-hidden shadow-2xl">
                  {(data.sections.phases || []).map((item, i) => (
                     <div key={i} className="bg-white p-6 md:p-10 hover:bg-slate-50 transition-colors group">
                        <div className="text-teal-600 font-mono text-xs mb-4 md:mb-6 flex items-center gap-2">
                           <span className="w-2 h-2 rounded-full bg-teal-600"></span>
                           {item.step} // HEALTH_SYNC_NODE
                        </div>
                        <h3 className="text-lg md:text-xl font-black text-slate-900 mb-2 md:mb-4 tracking-tight group-hover:text-teal-600 transition-colors uppercase leading-[1.4]">{item.stage}</h3>
            ...
            <div className="grid lg:grid-cols-2 gap-8 lg:gap-16 items-start mb-12 lg:mb-24">
               <div className="relative lg:sticky lg:top-32 mb-8 lg:mb-0">
                  <div className="w-12 h-12 md:w-16 md:h-16 bg-teal-50 rounded-xl md:rounded-2xl flex items-center justify-center text-2xl md:text-3xl text-teal-600 mb-6 md:mb-8 border border-teal-100">
                     <IoShieldCheckmarkOutline />
                  </div>
                  <h2 className="text-3xl md:text-5xl font-black text-slate-900 mb-4 md:mb-6 tracking-tighter leading-[1.1]">Vulnerability <br /> Neutralization <span className="text-teal-600">Logic.</span></h2>
                  <p className="text-slate-500 text-base md:text-lg font-light leading-[1.6] mb-6 md:mb-8">Every maintenance cycle includes a deep heuristic scan of your entire file structure, neutralising threats before they hit your live environment.</p>
                  ...
                  <div className="p-6 md:p-8 bg-slate-900 rounded-2xl md:rounded-3xl border border-slate-800 shadow-2xl flex items-center justify-between group cursor-default">
                     <div className="flex gap-3 md:gap-4 items-center">
                        <div className="w-10 h-10 md:w-12 md:h-12 rounded-xl bg-teal-500 flex items-center justify-center text-white shadow-lg"><IoSearchOutline className="text-xl md:text-2xl" /></div>
                        <div>
                           <p className="text-[9px] md:text-[10px] font-black text-white/40 uppercase tracking-widest leading-[1.4]">Active Scan</p>
                           <p className="text-[10px] md:text-xs font-bold text-white tracking-tight leading-[1.4]">THREAT_LEVEL::ZERO</p>
                        </div>
                     </div>
               ...
               <div className="space-y-4 md:space-y-6">
                  {(data.sections.roi || []).map((spec, idx) => (
                     <div key={idx} className="bg-white rounded-2xl md:rounded-[2.5rem] p-6 md:p-8 border border-slate-200 shadow-sm hover:shadow-xl transition-all">
                        <h4 className="text-[10px] font-black text-teal-600 uppercase tracking-[0.4em] mb-4 md:mb-6 leading-[1.4]">{spec.group} Framework</h4>
                        <div className="grid grid-cols-2 gap-3 md:gap-4">
                           {spec.items?.map(item => (
                              <div key={item} className="flex items-center gap-2 md:gap-3 text-xs md:text-sm font-bold text-slate-600 leading-[1.4]">
                                 <IoCheckmarkCircleOutline className="text-teal-600 text-base md:text-lg shrink-0" />
                                 <span>{item}</span>
                              </div>
                           ))}
                        </div>
            ...
            <div className="bg-white rounded-3xl md:rounded-[4rem] p-6 md:p-12 lg:p-24 border border-slate-100 shadow-2xl shadow-slate-200/50 relative overflow-hidden mb-12 lg:mb-24">
               ...
               <div className="grid lg:grid-cols-2 gap-8 md:gap-12 lg:gap-20 relative z-10">
                  <div>
                     <div className="text-teal-600 mb-4 md:mb-6 flex items-center gap-3 md:gap-4">
                        <div className="w-12 h-[2px] bg-teal-600"></div>
                        <span className="text-[10px] font-black uppercase tracking-[0.4em] leading-[1.4]">Performance Sovereignty</span>
                     </div>
                     <h2 className="text-3xl md:text-5xl font-black text-slate-900 mb-4 md:mb-6 leading-[1.1]">V8 Speed <br /><span className="text-teal-600">Architecture.</span></h2>
                     <p className="text-slate-500 text-base md:text-lg font-light leading-[1.6] mb-6 md:mb-8 italic">"Maintaining score 100/100 isn't just about code; it's about persistent database hygiene and asset vibration optimization."</p>
                     ...
                     <div className="space-y-2 md:space-y-4">
                        {[
                           ...
                           <div key={i} className="flex gap-3 md:gap-4 p-4 md:p-6 bg-slate-50 rounded-xl md:rounded-2xl border border-slate-100 items-start">
                              <div className="text-xl md:text-2xl text-teal-600 shrink-0 mt-0.5">{feat.i}</div>
                              <div>
                  ...
                  <div className="relative mt-8 lg:mt-0">
                     <div className="bg-slate-900 rounded-2xl md:rounded-[3rem] p-6 md:p-10 border border-slate-800 shadow-2xl aspect-auto md:aspect-[3/4] flex flex-col justify-between group overflow-hidden">
                        ...
                        <div className="space-y-6 md:space-y-8 relative z-10 mb-8 md:mb-0">
                           ...
                           <div className="space-y-4">
                              ...
                              <div className="flex items-center gap-3 md:gap-4">
                                 <div className="w-10 h-10 md:w-12 md:h-12 rounded-xl bg-white/5 border border-white/10 flex items-center justify-center text-teal-400 font-black text-xs shrink-0"><IoPulseOutline /></div>
                           ...
                           <div className="p-4 md:p-6 bg-white/5 rounded-xl md:rounded-2xl border border-white/5">
                              <p className="text-[8px] md:text-[9px] font-mono text-emerald-400 mb-2 tracking-tighter leading-[1.4]">SYSTEM_STABLE::VERIFIED</p>
                              <p className="text-[8px] md:text-[9px] font-mono text-slate-500 leading-[1.4]">UPTIME: 99.99%<br />THREATS: 0<br />VERSION: v8.4.2</p>
                           </div>
                        </div>
                        ...
                        <div className="bg-white/5 rounded-xl md:rounded-3xl border border-white/10 p-6 md:p-8 relative overflow-hidden group/m hover:bg-white/10 transition-all mt-auto relative z-10">
                           <IoTerminalOutline className="text-3xl md:text-4xl text-teal-600/30 mb-3 md:mb-4 group-hover/m:rotate-12 transition-transform" />
                           <p className="text-[8px] md:text-[9px] font-black text-white/50 uppercase tracking-widest mb-2 leading-[1.4]">Protocol: OPS_QA_VERIFIED</p>
                           <p className="text-[10px] md:text-xs font-bold text-white tracking-tight leading-[1.4]">System ready for absolute uptime.</p>
            ...
            <div className="text-center py-12 lg:py-20 border-t border-slate-200">
               <IoConstructOutline className="text-5xl lg:text-7xl text-teal-600 mb-6 md:mb-8 mx-auto opacity-20" />
               <h3 className="text-3xl sm:text-4xl lg:text-6xl font-black text-slate-900 mb-6 md:mb-8 leading-[1.1]">Protect your digital legacy. <br /><span className="text-transparent bg-clip-text bg-gradient-to-r from-teal-600 to-slate-900 font-serif italic font-medium">Engineer Absolute Uptime.</span></h3>
               <div className="flex flex-col sm:flex-row gap-3 md:gap-4 justify-center">
                  <button className="w-full sm:w-[240px] min-h-[48px] px-4 py-3 md:py-4 bg-teal-600 text-white font-black rounded-xl hover:bg-teal-700 transition-all shadow-xl shadow-teal-600/40 uppercase tracking-widest text-[10px] flex items-center justify-center leading-[1.4]">
                     {data.cta.title}
                  </button>
                  <Link
                     href="/freelancing"
         ...
         <div className="sticky bottom-0 left-0 w-full p-[var(--gutter,16px)] bg-white/90 backdrop-blur-md border-t border-slate-100 z-50 md:hidden flex items-center justify-between shadow-[0_-10px_40px_rgba(0,0,0,0.05)] pb-[max(1rem,env(safe-area-inset-bottom))] mt-auto">
            <div className="flex flex-col gap-0.5">
               ...
               <p className="text-slate-900 font-bold text-sm leading-[1.4]">Start Maintenance</p>
            </div>
            <button className="px-5 py-3 min-h-[48px] bg-teal-600 text-white font-black rounded-xl text-[10px] uppercase tracking-widest shadow-md shadow-teal-600/30 leading-[1.4] flex items-center justify-center">
               Initialize
            </button>
         </div>
      </section>
