...
export default function SocialCreativesDetailsClient({ data }) {
  ...
  return (
    <section className="min-h-screen bg-slate-50 text-slate-900 selection:bg-rose-600 selection:text-white pb-40 relative font-sans">
      ...
      <div className="container-custom pt-20">
        ...
        <div className="mb-48 px-4 md:px-0">
          <div className="flex items-center gap-6 mb-16">
            <h2 className="text-3xl font-black text-slate-900 tracking-tighter uppercase leading-none italic">The Creative Protocol</h2>
            <div className="h-[1px] flex-1 bg-slate-200"></div>
            <span className="text-[10px] font-black text-slate-400 uppercase tracking-widest leading-none">V6.1 Lifecycle</span>
          </div>
