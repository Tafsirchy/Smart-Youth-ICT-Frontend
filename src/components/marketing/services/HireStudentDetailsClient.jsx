      ...
      <section className="min-h-screen bg-slate-50 text-slate-900 selection:bg-amber-600 selection:text-white pb-40">
         ...
         <div className="container-custom pt-20">
                     ...
                     <div className="bg-slate-900 rounded-[3rem] p-10 border border-slate-800 shadow-2xl aspect-[3/4] flex flex-col justify-between group overflow-hidden">
                        ...
                        <div className="space-y-8 relative z-10">
                           ...
                           <div className="p-6 bg-white/5 rounded-2xl border border-white/5 font-mono">
                              <p className="text-[8px] text-emerald-400 mb-2 tracking-tighter">VETTING_STATUS::100%_CLEARED</p>
                              <p className="text-[8px] text-slate-500 leading-tight">MEMBER_ID: S_8210<br />SCORE: 96/100<br />VERIFIED: YES</p>
                           </div>
                        </div>
            ...
            <div className="text-center py-40 border-t border-slate-200 px-4 md:px-0">
               ...
               <h3 className="text-5xl lg:text-6xl font-black text-slate-900 mb-12 leading-tight">Ready to activate your <br /><span className="text-transparent bg-clip-text bg-gradient-to-r from-amber-600 to-indigo-600 font-serif italic font-medium">Talent Bridge?</span></h3>
