      ...
      <div className="container-custom py-20 relative z-10">
        ...
        <div className="mb-48 bg-white rounded-[5rem] p-12 lg:p-24 border border-slate-100 shadow-2xl shadow-slate-200/50 relative overflow-hidden mx-4 md:mx-0">
          ...
          <div className="grid lg:grid-cols-2 gap-20 items-center relative z-10">
            <div>
              <h2 className="text-5xl lg:text-6xl font-black text-slate-900 leading-[0.9] mb-10">Atomic <br /><span className="text-rose-600 font-serif italic font-medium">Logistics.</span></h2>
        ...
        <div className="mb-48 px-4 md:px-0">
          <div className="text-center max-w-2xl mx-auto mb-20 text-center">
            ...
            <p className="text-4xl md:text-5xl font-black text-slate-900 leading-tight">Select your <span className="text-slate-400">market engine.</span></p>
          </div>
        ...
        <div className="text-center py-40 border-t border-slate-100 px-4 md:px-0">
          ...
          <h3 className="text-5xl lg:text-6xl font-black text-slate-900 mb-12 leading-tight">{cta.title?.split('your ')[0]}your <br /><span className="text-transparent bg-clip-text bg-gradient-to-r from-rose-600 to-indigo-600 font-serif italic font-medium">{cta.title?.split('your ')[1]}</span></h3>
