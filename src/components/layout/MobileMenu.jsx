    ...
    <div className="md:hidden bg-white border-t border-gray-100 px-4 pb-4">
      <ul className="flex flex-col gap-1 pt-3">
        ...
        <MobileAccordion label="Services">
          <li>
            <Link href="/services" onClick={onClose} className="block px-3 py-1.5 text-[12px] font-black text-brand-pink uppercase tracking-widest">
              View All Services →
            </Link>
          </li>
        ...
        {session ? (
          <>
            {(() => {
              ...
              return (
                <Link href={`/${branchId}/${dashboardPath}`} onClick={onClose} className="btn-primary text-center text-sm">
                  Dashboard
                </Link>
              );
            })()}
